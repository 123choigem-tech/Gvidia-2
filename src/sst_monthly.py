...
# 전체 실행
# ---------------------------------------------------------------------------
def run(src_dir: str = os.path.join(_REPO_ROOT, "data", "input", "khoa_sst"),
        mean_dir: str = os.path.join(_REPO_ROOT, "data", "results", "sst_analysis", "mean_month"),
        diff_dir: str = os.path.join(_REPO_ROOT, "data", "results", "sst_analysis", "diff_month"),
